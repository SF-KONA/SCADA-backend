...
public interface AlarmRepository extends JpaRepository<Alarm, Long> {
    ...
    """)
    List<Alarm> findActiveAlarmsByEquipmentId(@Param("equipmentId") String equipmentId, @Param("now") LocalDateTime now);
    ...
    @Query("""
        ...
        ORDER BY a.occurredAt DESC
    """)
    List<Alarm> findAllAlarmsByEquipmentId(@Param("equipmentId") String equipmentId, @Param("now") LocalDateTime now);
